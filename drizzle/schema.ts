...
export const organizations = mysqlTable("organizations", {
  ...
  planTier: varchar("planTier", { length: 32 }).default("starter").notNull(),
  planStatus: varchar("planStatus", { length: 32 }).default("trialing").notNull(),
  stripeCustomerId: varchar("stripeCustomerId", { length: 64 }),
  stripeSubscriptionId: varchar("stripeSubscriptionId", { length: 64 }),
  stripeSubscriptionStatus: varchar("stripeSubscriptionStatus", { length: 32 }),
  stripePlanItemId: varchar("stripePlanItemId", { length: 64 }),
...
export const notifications = mysqlTable("notifications", {
  ...
  type: mysqlEnum("type", ["EVENT", "TASK", "ACTIVITY", "EMAIL"]).notNull(),
  title: varchar("title", { length: 200 }).notNull(),
  body: text("body"),
